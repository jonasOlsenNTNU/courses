...
public class ProvidersCoursesService {
    ...
    public Iterable<ProvidersCourses> findProvidersCoursesByCourseId(Integer id) {
        Iterable<ProvidersCourses> providersCourses = providersCoursesRepository.findByCid(id);
        return providersCourses;
    }
}
